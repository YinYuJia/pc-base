  ...
  export default {
    ...
    methods: {
      init (id) {
        ...
        this.$axios.get("/apiUrl/sys/menu/select").then((data) => {
          console.log("-------",data)
          ...
          if (!this.dataForm.id) {
            ...
            // 修改
            this.$axios.get(`/apiUrl/sys/menu/info/${this.dataForm.id}`).then((data) => {
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          ...
          this.$axios.post(`/apiUrl/sys/menu/${!this.dataForm.id ? 'save' : 'update'}`,{
